Pod::Spec.new do |s|
  ...
  s.source = {:http=>"https://adsdk.yumimobi.com/iOS/YumiMediationAdapters/4.0.0_1161.tar.bz2"}
  s.platforms = {"ios"=>"8.0"}
  ...
  s.subspec 'AdMob' do |sp|
    ...
    sp.dependency 'YumiAdMob', '7.42.2'
  ...
  s.subspec 'IronSource' do |sp|
    ...
    sp.dependency 'YumiIronSource', '6.8.1.0'
  end
  ...
  s.subspec 'Mintegral' do |sp|
    ...
    sp.dependency 'YumiMintegral', '5.3.1'
  end
  ...
  s.subspec 'IQzone' do |sp|
    ...
    sp.dependency 'YumiIQzone', '3.0.2141'
  end
end
