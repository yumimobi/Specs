Pod::Spec.new do |s|
  ...
  s.source = {:http=>"https://adsdk.yumimobi.com/iOS/YumiMediationAdapters/4.5.1_1747.tar.bz2"}
  s.platforms = {"ios"=>"8.0"}
  ...
  s.subspec 'AtmosplayAds' do |sp|
    ...
    sp.dependency 'AtmosplayAds', '3.0.1'
  end
  ...
  s.subspec 'Mintegral' do |sp|
    ...
    sp.dependency 'YumiMintegral', '5.8.8'
  end
