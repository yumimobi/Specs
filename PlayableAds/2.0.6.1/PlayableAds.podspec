Pod::Spec.new do |s|
  ...
  s.frameworks = ["UIKit", "Foundation", "WebKit", "SystemConfiguration", "MobileCoreServices", "AdSupport", "CoreLocation", "CoreTelephony", "StoreKit", "Security", "AudioToolbox"]
  s.libraries = "xml2"
  ...
  s.source = { :http => 'http://adsdk.yumimobi.com/iOS/PlayableAds/2.0.6.1_398.tar.bz2' }
