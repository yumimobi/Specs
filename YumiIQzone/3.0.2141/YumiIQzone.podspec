Pod::Spec.new do |s|
  ...
  s.resource = "**/MopubResources/*", "**/TapjoyResources.bundle"
  s.frameworks = "WebKit", "CoreMotion", "EventKit", "EventKitUI", "WatchConnectivity","AVFoundation","AudioToolbox","AdSupport","Foundation","UIKit","AVKit"
  s.libraries = "z",'xml2','c++','sqlite3.0'
  s.xcconfig = { 'OTHER_LDFLAGS' => '-ObjC'}

  s.dependency 'YumiMediationSDK'
