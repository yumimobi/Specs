Pod::Spec.new do |s|
  ...
  s.frameworks = ["UIKit", "StoreKit", "Foundation", "AVFoundation", "JavaScriptCore", "SystemConfiguration", "AdSupport", "CoreTelephony", "CoreLocation", "CoreMedia", "MobileCoreServices", "CoreGraphics"]
  s.weak_frameworks = "WebKit"
  s.xcconfig = {"OTHER_LDFLAGS"=>"-ObjC"}
  s.source = { :http => 'http://adsdk.yumimobi.com/iOS/YumiAdsSDK/3.0.0_.tar.bz2' }
