...
Pod::Spec.new do |s|
  ...
  s.frameworks = 'CoreGraphics', 'Foundation','UIKit','AdSupport','StoreKit','QuartzCore','CoreLocation','CoreTelephony','MobileCoreServices','Accelerate','AVFoundation'
  s.libraries = 'z','sqlite3'
  s.xcconfig = { 'OTHER_LDFLAGS' => '-ObjC' }
  s.requires_arc = true
  s.vendored_frameworks = 'MVSDK.framework' , 'MVSDKReward.framework'
