 Pod::Spec.new do |s|
    ...
    s.frameworks = "CoreTelephony","SystemConfiguration","AdSupport","MobileCoreServices"
    s.xcconfig = {"OTHER_LDFLAGS"=>"-ObjC"}
    s.source = { :http => 'http://adsdk.yumimobi.com/iOS/YumiAdsSDK/YUMINativeSDK_1.0.3.tar.bz2'}
