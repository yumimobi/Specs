Pod::Spec.new do |s|
  s.name = 'YumiMediationAdapterBytedance-OverSea'
  s.version = '4.6.1'
  ...
  s.source = {:http => "https://adsdk.yumimobi.com/iOS/YumiMediationAdapters/4.6.1_2020061601.tar.bz2"}
  s.source_files = 'BytedanceAds/**/*.{h,m}'
  s.platforms = {"ios"=>"9.0"}
  s.dependency 'YumiMediationSDK', '~> 4.6.0'
  s.dependency 'YumiBytedanceAds-OverSea', '3.0.0.2'
