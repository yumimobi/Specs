...
Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.vendored_frameworks = 'MTGSDK.framework' , 'MTGSDKInterstitialVideo.framework','MTGSDKInterstitial.framework','MTGSDKReward.framework','MTGSDKInterActive.framework','MTGSDKAppWall.framework','MTGSDKOfferWall.framework'
