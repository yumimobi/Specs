...
Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://adsdk.yumimobi.com/iOS/ThirdPartySDK/Mintegral/Mintegral_SDK_v#{s.version}.tar.bz2" }
  ...
  s.requires_arc = true
  s.vendored_frameworks = 'MTGSDK.framework' , 'MTGSDKInterstitialVideo.framework','MTGSDKInterstitial.framework','MTGSDKReward.framework','MTGSDKInterActive.framework'
