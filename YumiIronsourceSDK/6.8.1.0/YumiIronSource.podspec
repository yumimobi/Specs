Pod::Spec.new do |s|
  ...
  s.frameworks = "Foundation", "AVFoundation", "CoreMedia", "CoreVideo", "QuartzCore", "SystemConfiguration", "CoreGraphics", "CFNetwork", "MobileCoreServices", "StoreKit", "AdSupport", "CoreTelephony", "Security"
end
